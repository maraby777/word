...
Function.implement({
  ...
  /**
   * This .bind method wasn't been called in a browser. It was only called in tests, that's why the behavior in tests was different and caused tests to fail.
   * Browsers always used native Function.bind() method.
   */
